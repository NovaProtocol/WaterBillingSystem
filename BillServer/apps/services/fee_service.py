...
PAYMENT_METHODS: list[dict] = [
    ...
    {"code": "ecpay_loan",        "label": "ECPay Loan",               "channel_code": "OTC",     "fee_flat": 25.00,                          "xendit_fee": 11.00, "sort_order": 43},
    {"code": "ecpay_school",      "label": "ECPay School",             "channel_code": "OTC",     "fee_flat": 25.00,                          "xendit_fee": 11.00, "sort_order": 44},
    {"code": "ecpay_other",       "label": "ECPay Other Merchants",    "channel_code": "OTC",     "fee_percent": 1.50, "fee_minimum": 25.00, "xendit_fee": 11.00, "sort_order": 45},
